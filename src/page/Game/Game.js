        ...
        return (
            <div className="Game">
                ...
                <div className='game-screens'>
                    {(this.state.play ? 
                    <GameScreen session={this.props.session} gameState={this.state.gameState} socket={this.props.socket} analytics={this.cookies.get('accepted-cookies')} />
                    : 
                    <Lobby session={this.props.session} socket={this.props.socket} onStartClick={this.startGame} analytics={this.cookies.get('accepted-cookies')} />
                    )}
                    <Chat game={this.props.session.game} username={this.props.session.username} socket={this.props.socket} analytics={this.cookies.get('accepted-cookies')} />
                </div> 
